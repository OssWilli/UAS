...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Jan 2023 pada 17.18
...
INSERT INTO `meja` (`no_meja`, `keterangan`) VALUES
(1, 'Indoor'),
(2, 'indoor'),
(3, 'Indoor'),
(4, 'Indoor');
...
INSERT INTO `promo` (`id_promo`, `menu`, `harga_awal`, `harga_promo`) VALUES
(1, 'Bakso', 13000.00, 10000.00),
(7, 'Sushi', 150000.00, 120000.00);
...
(2, 'Deni', 'emaiol', '321321', 2, '2023-01-04', '22:03:10', 'tidak ada', 2, 2, 'indoor', 'Pending');
...
--
ALTER TABLE `promo`
  MODIFY `id_promo` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
