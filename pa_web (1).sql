...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 18, 2023 at 02:17 AM
...
(5, 'Nasi Goreng', 20000.00, '../static/img/nasgor.jpg');
...
CREATE TABLE `reservasi` (
  ...
  `pesan_menu` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `reservasi` (`id_pemesanan`, `nama`, `email`, `telp`, `jum_tamu`, `tanggal`, `jam`, `tambahan`, `id_user`, `meja_no`, `ket_meja`, `status`, `pesan_menu`) VALUES
...
--
ALTER TABLE `daftar_menu`
  MODIFY `id_menu` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
